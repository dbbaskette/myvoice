...
def test_compose_returns_404_for_unknown_pack(client_with_config) -> None:
    client, _ = client_with_config
...
def test_lint_endpoint_returns_hits(client_with_config) -> None:
    client, _ = client_with_config
    r = client.post(
        "/api/lint",
...
def test_lint_returns_404_for_unknown_pack(client_with_config) -> None:
    client, _ = client_with_config
